    ...
    methods: {
        ...
        mediaEffect: function() {
            ...
            [ "01", "apple", "cn", "ebc", "eco", "et", "fb", "free", "gg", "gon", "ig", "line", "mirror", "now", "one", "ptt", "setn", "son", "tvbs", "udn", "us", "yahoo", "yt" ].forEach(function(obj) {
                ...
                var radius = isMobile.phone ? Math.random() + 60 : Math.random() + 60, x = Math.random() * (canvas.width - 2 * radius) + radius, dx = Math.random() - .5, y = Math.random() * (canvas.height - 2 * radius) + radius, dy = Math.random() - .5;
